...
public final class WebApplicationContextSessionListener implements
	...
	private List retrieveAllListeners(HttpSessionEvent evt) {
		...
		Map<String, HttpSessionListener> m = webApplicationContext.getBeansOfType(HttpSessionListener.class,
				true, true);
		List<HttpSessionListener> l = new ArrayList<HttpSessionListener>(m.values());
