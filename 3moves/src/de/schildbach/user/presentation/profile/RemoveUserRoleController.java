 ...
 */
@Controller
public class RemoveUserRoleController extends ParameterizableViewController
{
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		Role role = Role.valueOf(ServletRequestUtils.getRequiredStringParameter(request, "role"));
		userService.removeUserRole(loggedInUser.getName(), user, role);

		return new ModelAndView(getViewName(), "user", user);
	}
}
