 ...
 */
@Controller
public class SetScreenResolutionController extends ParameterizableViewController
{
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		int resolution = ServletRequestUtils.getRequiredIntParameter(request, "resolution");

		environment.setScreenResolution(resolution);
