 ...
 */
@Controller
public class WatchedGamesController extends ParameterizableViewController
{
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		return new ModelAndView(getViewName(), "games", gameService.watchedGames(user.getName()));
	}
}
