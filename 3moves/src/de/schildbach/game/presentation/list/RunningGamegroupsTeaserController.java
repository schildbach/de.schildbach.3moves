 ...
 */
@Controller
public class RunningGamegroupsTeaserController extends ParameterizableViewController
{
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		return new ModelAndView(getViewName(), "games", gameService.selectedGameGroups(maxResults));
	}
}
