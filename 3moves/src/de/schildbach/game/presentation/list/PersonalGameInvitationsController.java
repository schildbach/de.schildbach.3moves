 ...
 */
@Controller
public class PersonalGameInvitationsController extends ParameterizableViewController
{
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		return new ModelAndView(getViewName(), "games", gameService.personalGameInvitations(user.getName()));
	}
}
