 ...
 */
@Controller
public class FormingSingleGamesTeaserController extends ParameterizableViewController
{
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		return new ModelAndView(getViewName(), "games", gameService.openGameInvitations(null, SingleGame.class, "CHESS",
				maxResults));
	}
}
